...
public class RESTfulApi {
    ...
    public String postData(@RequestBody Map<String, Object> data) {
        Integer[] idArray = dataMap.keySet().toArray(new Integer[0]);//获取key的集合，Integer类型
        Arrays.sort(idArray);//排序操作，默认是升序
        int nextId = idArray[idArray.length - 1] + 1;//获取最大的key然后+1
